    ...
    return (
        <div className='bg-white h-full text-gray-900 font-semibold text-start OrderSummury'>
            ...
            <div className='p-2 flex flex-col pr-20'>
                ...
                <button onClick={handleProccedToPayment} type="button" className="px-8 py-3  font-semibold   border border-orange-500  my-2 dark:text-orange-500">Confirm Order</button>
